...
function TruckTransaction() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await axios.post(`${API_URL}/api/truck-transactions`, formData);
      toast.success('🚚 Truck data submitted successfully!');
      setFormData({
        truckNo: '',
        transactionDate: new Date().toISOString().split('T')[0],
        cityName: '',
      ...
      console.error(error);
      toast.error('❌ Failed to submit truck data.');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      <div className="max-w-4xl mx-auto bg-white shadow-lg rounded-xl p-6">
        <h2 className="text-2xl font-bold mb-4 text-center">Truck Transaction</h2>
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Amount per Ton</label>
            <input
              type="number"
              name="amountPerTon"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Truck Weight (in tons)</label>
            <input
              type="number"
              name="truckWeight"
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700">Delivery Point</label>
            <input
              type="text"
              name="deliverPoint"
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="mt-1 block w-full border px-3 py-2 rounded-md h-24"
